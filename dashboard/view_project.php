...
$prod = $conn->query("SELECT * FROM user_productivityy where project_id = {$id}")->num_rows;
...
$manager = $conn->query("SELECT *, username as name FROM users where id = $manager_id");
				...
				<div class="col-md-12">
					<div class="row">
						...
						<div class="col-md-6">
							...
							<dl>
								<dt><b class="border-bottom border-primary">Admin Witel</b></dt>
								<dd>
			...
			<div class="card card-outline card-primary">
				...
				<div class="card-body">
					<ul class="users-list clearfix">
						<?php 
						if(!empty($user_ids)):
							$members = $conn->query("SELECT *, username as name FROM users where id in ($user_ids) order by username asc");
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-body">
					<?php 
					$progress = $conn->query("SELECT p.*,u.username as uname,u.avatar,t.task FROM user_productivityy p inner join users u on u.id = p.user_id inner join task_list t on t.id = p.task_id where p.project_id = $id order by unix_timestamp(p.date_created) desc ");
